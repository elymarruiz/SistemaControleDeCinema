 ...
 * @author elymar.8221
 */
public class ListSessao extends javax.swing.JFrame {

    /**
     * Creates new form ListSessao
     */
    public ListSessao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("CONSULTA DE SESSÃO");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jcbTipoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TODOS", "ID", "SALA", "FILME", "DATA", "HORARIO", "STATUS" }));
        ...
        tableSessao.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "SALA", "FILME", "DATA", "HORARIO", "STATUS"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListSessao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListSessao().setVisible(true);
            }
        });
    }
